        ...
        return (
            <Html lang="en">
                <Head>
                    ...
                    <script src="https://cdn.jsdelivr.net/npm/decimalsystem@1.1.0/dist/decimalsystem.min.js" integrity="sha256-tXuzTfFXQgfRvwj1sTcNHgJAgRbjMFXdeISTUGTC5cM=" crossOrigin="anonymous"/>
