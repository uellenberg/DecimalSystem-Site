...
| Name | Description | Type | Example |
| :--- | :--- | :--- | :--- |
| precision? | The maximum amount of decimal digits that will appear in the number. For example, if the default (8) is used, a number will always have 8 or fewer decimals. | [Number](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number) | 8 |