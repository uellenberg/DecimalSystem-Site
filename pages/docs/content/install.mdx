...
```html
<script src="https://cdn.jsdelivr.net/npm/decimalsystem@1.0.11/dist/decimalsystem.min.js" integrity="sha256-nRyjkyEyUvRF9D0jOSXsPUKj9FJ2DAL16wCsen7MCkU=" crossorigin="anonymous"></script>
```
